...
public final class ListImagesAction {
     ...
     */
    public String execute(HttpServletRequest request, HttpServletResponse response, String id)
...
//        if ((exists) && (uploaded == false)) {
        ...
        boolean androidApp = isAndroidApp(request);
    ...
    public boolean isAndroidApp(HttpServletRequest request) {
        /*
